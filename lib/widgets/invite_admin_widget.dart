...
class InviteAdminWidget extends StatefulWidget {
  const InviteAdminWidget({super.key});

  @override
  State<InviteAdminWidget> createState() => _InviteAdminWidgetState();
}

class _InviteAdminWidgetState extends State<InviteAdminWidget> {
  String? _inviteCode;
  bool _loading = false;
  bool _copied = false;
  ...
  Future<void> _fetchInviteCode() async {
    ...
    try {
      final code = _inviteCode == null
          ? await OrganizationService.getAdminInviteCode(token)
          : await OrganizationService.getNewAdminCode(token);
          ...
          children: [
            ElevatedButton(
              ...
              child: _loading
                  ...
                  : Text(
                      _inviteCode == null ? "Invite Admins" : "Get New Code",
                    ),
            ),
            if (_inviteCode != null) ...[
